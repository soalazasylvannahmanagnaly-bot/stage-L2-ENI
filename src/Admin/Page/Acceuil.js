...
function Acceuil() {
  ...
  const cards = [
    { title: "Véhicules", value: vehicules, icon: <FaCar/> },
    { title: "Chauffeurs", value: chauffeurs, icon: <FaUserTie/> },
    { title: "Missions", value: missions, icon: <FaTasks/> },
    { title: "Entretiens", value: entretiens, icon: <FaWrench/> },
    { title: "Carburants", value: carburants, icon: <FaGasPump/>},
  ];
